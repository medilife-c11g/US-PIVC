...
All analyses were performed using R (version 4.x) with the meta and metafor packages. A two-sided p-value < 0.05 was considered statistically significant. As a *post-hoc* sensitivity analysis (added after the initial meta-analytic run because of the small per-outcome k), all pooled estimates were re-examined using the restricted maximum likelihood (REML) estimator and the Hartung-Knapp-Sidik-Jonkman (HKSJ) confidence interval adjustment, which provides more conservative inference when the number of studies is small (k < 10).^15^ This sensitivity analysis was not pre-specified in the PROSPERO registration, and we present it as supportive rather than primary inference.
...
This review has several important limitations. First, the evidence base is small and heterogeneous, comprising only five RCTs and nine cohort studies with varied populations, settings, outcome definitions, and follow-up durations. Second, inter-rater agreement for screening was fair (Cohen's kappa = 0.330; percent agreement 95.8%), which is within the range commonly reported for systematic review title/abstract screening under conditions of high exclusion prevalence (98.5% exclusion rate). All 57 single-reviewer-include records were adjudicated by the primary reviewer in a pre-specified second-pass title/abstract review using the explicit PICO criteria; 53 second-reviewer-only includes were excluded at this stage (predominantly because abstracts described first-attempt insertion success rather than post-insertion outcomes, midline or long-peripheral catheters rather than peripheral IVCs, single-arm designs, or unpublished protocols), and 4 primary-reviewer-only includes advanced to full-text retrieval for further confirmation. We acknowledge that the second-pass adjudication relied on the primary reviewer's PICO judgment and could in principle have inadvertently excluded eligible studies; however, all post-hoc cross-references against four prior systematic reviews on this topic (referenced in Discussion) revealed no missed eligible studies, providing external check on this adjudication step. Third, four studies had major confounding by catheter type or selection, necessitating their exclusion from pooled analyses. Fourth, Saltarelli et al. (2015) was available only as a conference abstract with limited methodological detail. Fifth, Varghese et al. (2025) employed only a two-hour follow-up, which is insufficient to capture most post-insertion complications. Sixth, Leroux et al. (2023) was substantially underpowered due to COVID-19-related recruitment challenges. Seventh, formal assessment of publication bias was not possible because fewer than 10 studies contributed to any single meta-analysis. Finally, the overall certainty of evidence as assessed by the GRADE framework ranged from low to very low across all outcomes (Table 3),^12^ reflecting the predominance of observational studies, serious imprecision, and the limitations of the available RCTs.
...
| Extravasation | 3 (2 RCTs, 1 cohort) | 29,682 | Not pooled — outcomes fundamentally incomparable (I^2^=95.7%); narrative synthesis only | ⊕◯◯◯ **Very low** | Very serious inconsistency (I^2^=95.7%; incompatible populations and outcome definitions); serious indirectness; serious risk of bias |
